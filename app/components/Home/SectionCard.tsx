...
const SectionCard = ({ img, title, des, secIndex, isRight = true }: Props) => {
  ...
  return (
    <div className={`w-full py-8 sm:py-16 ${bgColor}`}>
      <Wrapper>
        <div className='w-full flex flex-col-reverse md:grid grid-cols-[1.2fr,1fr] lg:grid-cols-2 gap-4 md:gap-8 lg:gap-12'>
          <div
          ...
          >
            <p className='text-black text-[30px] md:text-[35px] lg:text-[40px] tracking-wider leading-[35px] md:leading-[50px] font-semibold'>
              {title}
            </p>
